...
def trans_img(path_and_labels, image_size):
...
def trans_img_data():
    ...
    img_size = (3, 55, 47)  # channel, height, width
    test_x, test_y = trans_img(test_path_and_labels, img_size)
    train_x, train_y = trans_img(train_path_and_labels, img_size)

    msgpack_numpy.dump((train_x, train_y), open(train_image_file,'wb'))
    msgpack_numpy.dump((test_x, test_y), open(test_image_file,'wb'))
