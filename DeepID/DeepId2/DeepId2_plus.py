...
import theano
from ..util.DeepId import euclidean_distance, eucl_dist_output_shape, contrastive_loss, create_pair_data, \
    compute_accuracy, create_deepId_network
...
def build_deepid2plus_model(input_shape, nb_classes):
    print('building deepid2 plus model')
...
def train_valid_deepid2plus(X_train, y_train, X_test, y_test, nb_classes, model_file, weight_file):
    ...
    model = build_deepid2plus_model(input_shape, nb_classes)
