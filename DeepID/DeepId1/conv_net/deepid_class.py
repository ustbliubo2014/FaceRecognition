...
from DeepID.DeepId1.conv_net.layers import *
...
if __name__ == '__main__':
    if len(sys.argv) != 4:
        ...
        sys.exit()
    simple_deepid(learning_rate=0.01, n_epochs=20, dataset=(sys.argv[1], sys.argv[2]),
                  params_file=sys.argv[3], nkerns=[20,40,60,80], batch_size=500, n_hidden=160, n_out=1595, acti_func=relu)
