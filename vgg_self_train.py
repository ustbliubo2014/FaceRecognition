...
@file: vgg_self_train.py
@time: 2016/8/9 16:53
@contact: ustb_liubo@qq.com
@annotation: vgg_self_train
"""
import sys
import logging
...
class DeepFace():
    def __init__(self):
        ...
        self.model_file = os.path.join(self.model_folder, 'self_deep_face.model')
        self.weight_file = os.path.join(self.model_folder,'self_deep_face.weight')
        self.part_func = None
