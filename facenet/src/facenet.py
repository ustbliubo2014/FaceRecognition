...
def read_and_augment_data(image_list, label_list, image_size, batch_size, max_nrof_epochs, random_crop, random_flip,
                          random_rotate, nrof_preprocess_threads, shuffle=True):
...
def get_learning_rate_from_file(filename, epoch):
    # 从配置文件中读入学习率的配置(不同的epoch使用不同的学习率[楼梯形式的下降])
