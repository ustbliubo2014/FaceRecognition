...
def parse_arguments(argv):
    ...
    parser.add_argument('--logs_base_dir', type=str,
        help='Directory where to write event logs.', default='/home/liubo-it/FaceRecognization/facenet/log/casia_log')
    parser.add_argument('--models_base_dir', type=str,
        help='Directory where to write trained models and checkpoints.', default='/home/liubo-it/FaceRecognization/facenet/models/casia_facenet')
    ...
    parser.add_argument('--baihe_pack_file', type=str,
        help='Path to the pack file containing aligned face patches.', default='')
