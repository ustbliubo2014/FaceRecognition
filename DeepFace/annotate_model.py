...
if __name__ == '__main__':
    ...
    model_file = '/data/liubo/face/vgg_face_dataset/model/annotate_deep_face_%d.model'%(nb_classes)
    weight_file = '/data/liubo/face/vgg_face_dataset/model/annotate_deep_face_%d.weight'%(nb_classes)
