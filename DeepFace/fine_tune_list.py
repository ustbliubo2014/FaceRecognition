...
@file: fine_tune_list.py
@time: 2016/8/30 11:00
@contact: ustb_liubo@qq.com
@annotation: fine_tune_list
"""
import sys
import logging
...
if __name__ == '__main__':
    ...
    (train_sample_list, valid_sample_list) = msgpack_numpy.load(
                        open('/data/pictures_annotate_feature/sample_list.p', 'rb'))
    train_valid_model(train_sample_list, valid_sample_list, pic_shape, nb_class, model_file, weight_file)
