...
if __name__ == '__main__':
    ...
    mlp_model_file = '/data/liubo/face/vgg_face_dataset/model/orl_fc7.model'
    mlp_weight_file = '/data/liubo/face/vgg_face_dataset/model/orl_fc7.weight'
    merge_model_file = '/data/liubo/face/vgg_face_dataset/model/orl_deep_face_%d.model'%nb_class
    merge_weight_file = '/data/liubo/face/vgg_face_dataset/model/orl_deep_face_%d.weight'%nb_class
