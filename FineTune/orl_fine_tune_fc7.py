...
@file: orl_fine_tune_fc7.py
@time: 2016/8/18 19:21
@contact: ustb_liubo@qq.com
@annotation: orl_fine_tune_fc7
"""
import sys
import logging
...
def load_model(layer_index=-3):
    model_file = '/data/liubo/face/vgg_face_dataset/model/orl_deep_face_31.model'
    weight_file = '/data/liubo/face/vgg_face_dataset/model/orl_deep_face_31.weight'
...
if __name__ == '__main__':
    data, label = load_data(orl_fc7_data_path)
    ...
    model_file = '/data/liubo/face/vgg_face_dataset/model/orl_fc7.model'
    weight_file = '/data/liubo/face/vgg_face_dataset/model/orl_fc7.weight'
