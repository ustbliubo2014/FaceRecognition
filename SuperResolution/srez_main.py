...
@software: PyCharm
@file: autoencoder.py
@time: 2017/2/16 16:52
@contact: ustb_liubo@qq.com
@annotation: srez_main
"""
...
tf.app.flags.DEFINE_integer('train_batch_num', 500000,
                            "train batch num.")
...
tf.app.flags.DEFINE_string('dataset', '/data/liubo/face/CelebA/img_align_celeba',
