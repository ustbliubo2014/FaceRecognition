...
from DeepID.DeepId3.DeepId3 import train_valid_deepid3, extract_feature
...
if __name__ == '__main__':
    ...
    weight_file = os.path.join(data_folder, 'orl.deepid3.weight')
    model_file = os.path.join(data_folder, 'orl.deepid3.model')
    print 'model_file : ', model_file, ' weight_file : ', weight_file
    train_valid_deepid3(X_train, y_train, X_test, y_test, nb_classes, model_file, weight_file)
