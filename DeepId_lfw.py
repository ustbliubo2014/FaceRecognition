...
class DeepId():
    def __init__(self, model_type, person_num):
        ...
        self.deepid_model_file = os.path.join(self.model_folder, 'lfw.rgb.deepid.model')
        self.deepid_weight_file = os.path.join(self.model_folder,'lfw.rgb.deepid.weight')
    ...
    def train_vgg_face(self):
        ...
        data, label = load_train_data('/data/liubo/face/lfw_face', shape=self.pic_shape,
                        pic_num_threshold=self.pic_num_threshold, part_func=None, person_num=self.person_num)
