...
@annotation: lfw_annotation_valid
"""
import os
import sys
reload(sys)
...
model_file = '/data/liubo/face/vgg_face_dataset/model/annotate.all_data.mean.rgb.deepid_relu.deep_filters.model'
weight_file = '/data/liubo/face/vgg_face_dataset/model/annotate.all_data.mean.rgb.deepid_relu.deep_filters.weight'
from lfw_keras_vgg_valid import get_Conv_FeatureMap, read_one_rgb_pic, pic_shape

lfw_folder = '/data/liubo/face/lfw_face'
pair_file = '/data/liubo/face/lfw_pair.txt'
feature_pack_file = '/data/liubo/face/lfw_annotate_feature.p'
