...
# print api.detection.detect(url='http://cn.faceplusplus.com/static/resources/python_demo/1.jpg')
result = api.detection.detect(img = File('C:\Users\liubo\Desktop\picture\skyeye_pic/dongliwei.jpg'))
print api.detection.detect(img = File('C:\Users\liubo\Desktop\picture\skyeye_pic/huangwei.jpg'))
