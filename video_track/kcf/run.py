...
if __name__ == '__main__':
	...
	while(cap.isOpened()):
		...
		if(selectingObject):
			...
			if boundingbox[0]+boundingbox[2]/2 < 0 or boundingbox[0]+boundingbox[2]/2 > frame.shape[1] or \
				boundingbox[1]+boundingbox[3]/2 < 0 or boundingbox[1]+boundingbox[3]/2 > frame.shape[0]:
				onTracking = False
				continue

			print t1 - t0, boundingbox, frame.shape
